          ...
          <ol>
            ...
            <ol className="list-decimal list-outside text-justify p-5">
              <li className="list-decimal">
                Authors are invited to submit their paper electronically using a
                proceedings template written in English, with a length of up to
                10 pages, a full paper presenting the results of original
                research or an innovative paper, and a short paper that is
                partially completed with a theoretically established idea to
                practical applications relevant to the conference. Over the ten
                (10) page limit, additional pages per paper will be charged.
              </li>
              <br />
              <li className="list-decimal">
                All submissions must be made electronically through the
                editorial manager/Submission Management System, and all accepted
                and presented papers will be included in Procedia Computer
                Science Journal, Elsevier for possible publication and indexing
                in databases such as ScienceDirect, Scopus, Google Scholar,
                INSPEC, Web of Science, and Journal Citation Report (JCR), among
                others.
              </li>
              <br />
              <li className="list-decimal">
                All manuscripts submitted to ICMLDE 2022 will undergo a
                peer-review process and the submitted manuscript will be
                reviewed by at least three reviewers. The review process will be
                double-blind.
              </li>
              <br />
              <li className="list-decimal">
              ...
              <br />
              <li className="list-decimal">
                The acceptance of the paper will be released after completion of
                peer review process.
              </li>
              <br />
            </ol>
            ...
            <p className="p-5">
              ...
              avoided. If you incorporate a model, concept, figure, table, data,
              or concluding statement from a previously published work, make
              sure to correctly cite the source research work. Also, the
              language you use to explain it should not be the same as the
              language used in the research work from which you adapted it. You
              should get permission from the copyright owners before utilizing
