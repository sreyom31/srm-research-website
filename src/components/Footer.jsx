...
const Footer = () => {
  return (
    <div className="bg-sky-600 w-full mx-auto  bottom-0 text-gray-300">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-4 pb-3 text-white text-medium pb-8">
        <span>© Copyright SRM ICIot 2023. All rights reserved.</span>
        <span>
          <a href="https://www.srmist.edu.in/terms-and-conditions/">
            Terms of Use
          </a>{' '}
        </span>
